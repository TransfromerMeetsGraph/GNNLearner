...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_tasks=1, num_layers=5, emb_dim=300,
        ...
        self.dump_features_collector = dump_features_collector  # type: list
    ...
    def forward(self, batched_data):
        ...
        h_graph = self.pool(h_node, batched_data.batch)     # type: torch.Tensor

        if self.dump_features_collector is not None:
            self.dump_features_collector.append(h_graph.detach().cpu().numpy())
