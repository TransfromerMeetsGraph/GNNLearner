...
def main_mlp():
    ...
    parser.add_argument('--dataset_dir', type=str, default='/blob2/yinxia/wu2/data/molecule/kdd_dataset', help='directory to dataset')
    ...
    dataset = PCQM4MDataset(root=args.dataset_dir, only_smiles=True)
