...
class PCQM4MEvaluator:
    ...
    def save_test_submission(self, input_dict, dir_path, subset='test', extra_name=''):
        """
        ...
        if subset == 'test':
            pred_filename = 'y_pred_pcqm4m'
        elif subset == 'valid':
            pred_filename = 'valid_y_pred_pcqm4m'
        else:
            pred_filename = 'train_y_pred_pcqm4m'
        pred_filename += extra_name

        filename = osp.join(dir_path, pred_filename)
        ...
        if subset == 'test':
            ...
            assert y_pred.shape == (380670,)
        else:
            assert y_pred.shape == (3045360,)
